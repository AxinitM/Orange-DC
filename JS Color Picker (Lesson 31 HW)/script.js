// color src = https://meyerweb.com/eric/css/colors/
const colors = [
  ...
  { name: "palevioletred", hex: "#D87093", rgb: "rgb(216,112,147)" },
...
const choseColorButton = document.getElementById("button");
const colorField = document.getElementById("colorField");
const colorName = document.getElementById("colorNameText");

choseColorButton.addEventListener("click", function () {
  const randomColor = colors[Math.floor(Math.random() * colors.length)];

  colorField.style.backgroundColor = randomColor.name;

  colorName.innerHTML = `
              <strong>Color name:</strong> ${randomColor.name};<br>
              <strong>HEX code:</strong> ${randomColor.hex};<br>
              <strong>RGB code:</strong> ${randomColor.rgb}.`;
});
